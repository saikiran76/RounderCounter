...
const Login = () =>{
    ...
    return <div className="bg-[#0F172A] shadow-[#F472B6] shadow-lg h-screen flex justify-center font-inter">
    <div className="flex flex-col justify-center">
      <div className="rounded-lg bg-white w-80 text-center p-2 h-max px-4 shadow-[#F472B6] shadow-lg">
        ...
        <Bar text="Sign up with Google" margin="mb-2" content={<img src="https://image.similarpng.com/very-thumbnail/2020/06/Logo-google-icon-PNG.png" className="w-[2rem] rounded-2xl" alt="g"/>}/>
